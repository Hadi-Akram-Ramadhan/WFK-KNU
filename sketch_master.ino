...
void loop() {
  ...
  if (distance < 15.0) { // DANGER MODE (< 15cm: Air di gelas mau penuh / meluap)
  ...
  } else if (distance >= 15.0 && distance <= 18.0) { // CAUTION MODE (15-18cm: Air dasar gelas)
  ...
  } else { // SAFE MODE (> 18cm: Gelas kosong / air di dasar)
